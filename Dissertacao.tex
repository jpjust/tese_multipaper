...
\newcommand{\ppgmmes}          {julho}
\newcommand{\ppgmano}          {2022}
...
% O pacote abntex2cite não funciona com chapterbib
% \usepackage{abntex2cite}
% \usepackage[alf]{abntex2cite}

% Devemos usar o biblatex no lugar
...
\begin{document}
    ...
    \include{Chapters/1-Survey/texto}
    \include{Chapters/2-EDUs/texto}

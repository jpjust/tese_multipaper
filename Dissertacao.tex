...
\documentclass[fancyheadings, fancychapter, sureport, twoside]{PPGM-UEFS}
...
\newcommand{\ppgmtitulo}       {Classificação de Riscos e Planejamento de Soluções Inteligentes Utilizando Dados Georreferenciados Abertos para Construção de Cidades Resilientes}
\newcommand{\ppgmsubtitulo}    {}
...
\ppgmbanca{Profa. Dra. Elane Fiuza Borges}{\ppgmcooruniv}

%% Indique os membros externos da banca (nome e instituição)
\ppgmbancaext{Prof. Dr. Carlos Alberto Cioce Sampaio}{UNIVERSIDADE REGIONAL DE BLUMENAU}
\ppgmbancaext{Prof. Dr. Ricardo Araújo Rios}{UNIVERSIDADE FEDERAL DA BAHIA}
\ppgmbancaext{Prof. Dr. Rodrigo Tripodi Calumby}{UNIVERSIDADE ESTADUAL DE FEIRA DE SANTANA}
...
\addbibresource{Chapters/1-Introducao/references.bib}
\addbibresource{Chapters/2-Survey/references.bib}
\addbibresource{Chapters/3-EDUs/references.bib}
\addbibresource{Chapters/4-CityZones/references.bib}
\addbibresource{Chapters/5-AoM/references.bib}
\addbibresource{Chapters/6-Flood/references.bib}
...
\begin{document}
    ...
    \includepdf[pages={1}]{folha_banca.pdf}
    ...
    \include{Chapters/1-Introducao/texto}
    \include{Chapters/2-Survey/texto}
    \include{Chapters/3-EDUs/texto}
    \include{Chapters/4-CityZones/texto}
    \include{Chapters/5-AoM/texto}
    \include{Chapters/6-Flood/texto}
    \include{Chapters/7-Conclusao/texto}
